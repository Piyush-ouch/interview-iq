                ...
                <div className='relative'>
                    ...
                    {showUserPopup && (
                        <div className='absolute right-0 mt-3 w-64 bg-white dark:bg-slate-900 shadow-xl border border-gray-200 dark:border-slate-800 rounded-xl p-4 z-50 text-gray-800 dark:text-gray-100'>
                            ...
                            <button onClick={() => { navigate("/whiteboard"); setShowUserPopup(false); }} className='w-full text-left text-sm py-1.5 hover:text-black dark:hover:text-white text-gray-600 dark:text-gray-300 flex items-center justify-between font-medium cursor-pointer'>
                            ...
                            <button onClick={() => { navigate("/interview-style"); setShowUserPopup(false); }} className='w-full text-left text-sm py-1.5 hover:text-black dark:hover:text-white text-gray-600 dark:text-gray-300 flex items-center justify-between font-medium cursor-pointer'>
                              AI Interviewer Style Transfer
                              <span className="bg-teal-100 text-teal-700 dark:bg-teal-900/60 dark:text-teal-300 text-[10px] px-1.5 py-0.5 rounded-full font-bold">AI TONE 🎭</span>
                            </button>
