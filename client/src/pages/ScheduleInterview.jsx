...
function ScheduleInterview() {
  ...
  const [activeTab, setActiveTab] = useState("schedule"); // 'schedule' or 'my-bookings'
  ...
  // Fetch bookings on load or when switching tabs
  ...
  // Set default scheduledAt time to 1 hour from now
  useEffect(() => {
